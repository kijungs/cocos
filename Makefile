...
demo: $(TARGET)
	mpirun -n 31 $(TARGET) --trial 3 --budget 100000 --tolerance 0.2 example_graph.txt output_opt
	mpirun -n 31 $(TARGET) --method simple --trial 3 --budget 100000 example_graph.txt output_simple
	mpirun -n 31 $(TARGET) --method naive --trial 3 --budget 100000 example_graph.txt output_trifly
